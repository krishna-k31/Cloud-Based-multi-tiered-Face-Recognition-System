...
# python workload_generator.py --num_request 1000  --url 'http://52.55.175.185:80'  --image_folder "face_images_1000/" --prediction_file "classification_face_images_1000.csv"

# python workload_generator.py --num_request 1000  --url 'http://127.0.0.1:5000'  --image_folder "face_images_1000/" --prediction_file "classification_face_images_1000.csv"


# python workload_generator.py --num_request 1000  --url 'http://127.0.0.1:8000'  --image_folder "face_images_1000/" --prediction_file "classification_face_images_1000.csv"
